				...
				<!-- Banner -->
					<section id="intro" class="main">
						...
						<head>
							...
							<h2>ABOUT US</h2>
							<p>Our team’s expertise and knowledge of how users behave with the app, help in building top scalable web applications. As our website development companies can provide high value web applications of varied category. Our teams worked with top brands, companies and successful start-ups to create influential apps from brilliant ideas.</p>
